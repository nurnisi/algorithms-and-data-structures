import java.util.*;
    ...
    static boolean isIn2(int x1, int y1, int x2, int y2, int x3, int y3, int x0, int y0) {
        return doubleArea(x1, y1, x2, y2, x3, y3) == (doubleArea(x1, y1, x2, y2, x0, y0)
                                                    + doubleArea(x1, y1, x3, y3, x0, y0)
                                                    + doubleArea(x2, y2, x3, y3, x0, y0));
    }

    static long doubleArea(int x1, int y1, int x2, int y2, int x3, int y3) {
